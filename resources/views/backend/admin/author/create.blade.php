...
<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{{__('New Author')}}</li>
        </ol>
    </section>
    <div class="content">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-success box-solid">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{__('New Author')}}</h3>
                    ...
                    <div class="box-body">
                        ...
                        <form action="{{route('authors.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-9">
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" placeholder="{{__('Date Of Birth')}}" name="birth_date" value="{{old('birth_date')}}" autocomplete="off" id="birth_date">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <input type="text" class="form-control" placeholder="{{__('Date Of Death')}}" name="death_date" value="{{old('death_date')}}" autocomplete="off" id="death_date">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <div class="col-md-12">
                                            ...
                                            <textarea name="biography" id="editor1" >{{old('biography')}}</textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
